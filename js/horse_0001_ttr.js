...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: '体重',
      data: [402,397,399,395,398,397,400,401,398,399,396,401,405,403,405,408,408,408,407,405,403,408,410,408,406,410,412,409,411,409,406,],
      borderColor: '#333',
    }, {
      label: '体温',
      data: [37.5, 37.3, 37.3, 37.1, 37.3, 37.8, 37.7, 37.9, 37.6, 37.8, 37.8, 37.7, 37.7, 37.9, 37.8, 37.6, 37.9, 37.9, 37.7, 37.9, 37.9, 37.7, 37.8, 37.7, 37.2, 37.6, 37.8, 37.7, 37.8, 37.7, 37.8, ],
      borderColor: '#f88',
      yAxisID: 'y2',
    }],
  },
