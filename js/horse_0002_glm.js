...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: '体重',
      data: [478,478,478,477,481,483,480,485,483,488,486,485,488,484,488,490,490,493,495,499,498,498,497,496,496,497,497,498,493,496,492,],
      borderColor: '#333',
    }, {
      label: '体温',
      data: [37.3, 37.3, 37.4, 37.2, 37.4, 37.4, 37.5, 37.6, 37.4, 37.4, 37.1, 37.4, 37.4, 37.1, 37.4, 37.4, 37.4, 37.1, 37.2, 37.1, 37.2, 37.4, 37.4, 37.2, 37.2, 37.4, 37.1, 37.4, 37.2, 37.4, 37.2, ],
      borderColor: '#f88',
      yAxisID: 'y2',
    }],
  },
